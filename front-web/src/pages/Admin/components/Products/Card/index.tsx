            ...
            <div className="row">
                ...
                <div className="col-7 py-3">
                    ...
                    <div>
                        ...
                        <span className="badge rounded-pill bg-secondary mr-2">Categoria 4</span>
                        <span className="badge rounded-pill bg-secondary mr-2">Categoria 5</span>
                        <span className="badge rounded-pill bg-secondary mr-2">Categoria 6</span>
                    </div>
                </div>
