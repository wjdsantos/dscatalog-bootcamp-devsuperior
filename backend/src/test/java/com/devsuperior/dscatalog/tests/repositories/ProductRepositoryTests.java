...
public class ProductRepositoryTests {
	...
	private long countPCGamerlProducts;
	private PageRequest pageRequest;
	private long countCategory3Products;
	

	@BeforeEach // É usado p/ sinalizar que o método deve ser executado antes de cada método
				// @Test na classe atual.
	void setUp() throws Exception {
		existingId = 1L;
		nonExistingId = 1000L;
		countTotalProducts = 25L;
		countPCGamerlProducts = 21L;
		pageRequest = PageRequest.of(0, 10);
		countCategory3Products = 23L;
	}

	@Test
	public void findShouldReturnOnelySelectCategoryWhenCategoryInformed() {
		...
		Assertions.assertFalse(result.isEmpty());  //Não pode ser vazia
	...
	public void findShouldReturnProductsWhenNameExistsIgnoringCase() {
		...
		Assertions.assertEquals(countPCGamerlProducts, result.getTotalElements());
	}
